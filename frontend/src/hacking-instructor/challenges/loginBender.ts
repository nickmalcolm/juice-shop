...
export const LoginBenderInstruction: ChallengeInstruction = {
  ...
  hints: [
    ...
    },
    {
      ...
      fixture: '#email',
      unskippable: true,
      resolved: waitForInputToHaveValue('#email', 'bender@hacker-sto.re') // TODO Use domain from config instead
    },
    {
    ...
    },
    {
      ...
      fixture: '#email',
      unskippable: true,
      resolved: waitForInputToHaveValue('#email', "jim@hacker-sto.re'--") // TODO Use domain from config instead
    },
    {
